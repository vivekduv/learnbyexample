package org.learnbyexample.plain;
...
public class ProducerDemoWithCallbackMainApp {

    private static final Logger log = LoggerFactory.getLogger(ProducerDemoWithCallbackMainApp.class.getSimpleName());
